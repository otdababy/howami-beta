    ...
    return SizeConfigInit(
      ...
      builder: (BuildContext context, Orientation orientation) {
        ...
        '위로와 격려를 해준다','현명한 조언을 해준다'], const['T력 상실', '일 할때 만큼은 T', 'T와 F 사이 어딘가', '암 Like tt~', '너 T야?'], const [['공감에 도를 튼 T력 꼴찌','노트북이 최애 영화','너 슬퍼? 나도 슬퍼','공감이 세상에서 제일 쉬웠어요','마음을 헤아리는게 가장 중요하지',
              ...
              '/mental' : (context) => ScenarioPage('회복탄력성 ',const ['식당에서 \“저기요\”하고 불렀는데 직원이 오지 않는다' , '처음 본 사람이 내 패션을 칭찬한다' , '다음 주까지 처리해야 할 일이 생겼다' , '자려고 누웠는데 흑역사가 떠오른다' ,
              '주말 아침 7시에 윗집이 청소기를 돌린다' , '친구 애인이 바람피는 장면을 목격한다' , '사람이 붐비는 지하철에서는' , '가방을 열어보니 지갑이 없다' , '시험 전 날 애인에게 차였다' , '흰 옷을 입었는데 빨간 국물이 튀었다'],
